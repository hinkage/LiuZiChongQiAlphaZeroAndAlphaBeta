...
# 数据库被黑客删除后,重启训练,从tensorboard日志得到的参数
insert into policy_update values('33c14066-6469-11e9-aa39-086266e2cb2c', 0,
                                 1.0, 0.4444444552063942, 0.005, 0.002222222276031971, 1.8099762201309204, 1.6073437929153442, 0, 0,
                                 now(), 'from_self_play');